...
import com.wm_app_store.wm_app_store2.service.UserService;
 ...
 * @see User
 */
@RestController("WM_APP_STORE2.UserController")
@Api(value = "UserController", description = "Exposes APIs to work with User resource.")
@RequestMapping("/WM_APP_STORE2/User")
public class UserController {

    private static final Logger LOGGER = LoggerFactory.getLogger(UserController.class);

    @Autowired
	@Qualifier("WM_APP_STORE2.UserService")
