...
import com.wm_app_store.wm_app_store2.service.AppDownloadHistoryService;
 ...
 */
@RestController("WM_APP_STORE2.AppDownloadHistoryController")
@Api(value = "AppDownloadHistoryController", description = "Exposes APIs to work with AppDownloadHistory resource.")
@RequestMapping("/WM_APP_STORE2/AppDownloadHistory")
public class AppDownloadHistoryController {
    ...
    @Autowired
	@Qualifier("WM_APP_STORE2.AppDownloadHistoryService")
