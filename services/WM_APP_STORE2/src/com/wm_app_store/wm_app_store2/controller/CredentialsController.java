...
import com.wm_app_store.wm_app_store2.service.CredentialsService;
 ...
 * @see Credentials
 */
@RestController("WM_APP_STORE2.CredentialsController")
@Api(value = "CredentialsController", description = "Exposes APIs to work with Credentials resource.")
@RequestMapping("/WM_APP_STORE2/Credentials")
public class CredentialsController {

    private static final Logger LOGGER = LoggerFactory.getLogger(CredentialsController.class);

    @Autowired
	@Qualifier("WM_APP_STORE2.CredentialsService")
