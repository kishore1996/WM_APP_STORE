 ...
 * @see AppSource
 */
@Service("WM_APP_STORE2.AppSourceService")
@Validated
public class AppSourceServiceImpl implements AppSourceService {
    ...
    @Lazy
    @Autowired
    @Qualifier("WM_APP_STORE2.AppD0wnloadHostoryService")
    private AppD0wnloadHostoryService appD0wnloadHostoryService;

    @Autowired
    @Qualifier("WM_APP_STORE2.AppSourceDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service WM_APP_STORE2 for table AppSource to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service WM_APP_STORE2 for table AppSource to {} format", options.getExportType());
