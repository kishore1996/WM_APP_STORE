 ...
 * @see Credentials
 */
@Service("WM_APP_STORE2.CredentialsService")
@Validated
public class CredentialsServiceImpl implements CredentialsService {
    ...
    @Autowired
    @Qualifier("WM_APP_STORE2.CredentialsDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service WM_APP_STORE2 for table Credentials to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service WM_APP_STORE2 for table Credentials to {} format", options.getExportType());
