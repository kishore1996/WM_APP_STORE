...
import com.wm_app_store.wm_app_store2.User;
 ...
 * @see User
 */
@Service("WM_APP_STORE2.UserService")
@Validated
public class UserServiceImpl implements UserService {
    ...
    @Autowired
    @Qualifier("WM_APP_STORE2.UserDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service WM_APP_STORE2 for table User to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service WM_APP_STORE2 for table User to {} format", options.getExportType());
