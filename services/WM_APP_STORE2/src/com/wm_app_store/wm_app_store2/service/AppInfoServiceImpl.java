 ...
 * @see AppInfo
 */
@Service("WM_APP_STORE2.AppInfoService")
@Validated
public class AppInfoServiceImpl implements AppInfoService {
    ...
    @Lazy
    @Autowired
    @Qualifier("WM_APP_STORE2.AppScreenshotsService")
    ...
    @Autowired
    @Qualifier("WM_APP_STORE2.AppInfoDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service WM_APP_STORE2 for table AppInfo to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service WM_APP_STORE2 for table AppInfo to {} format", options.getExportType());
