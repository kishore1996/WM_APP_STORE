 ...
 * @see AppScreen
 */
@Service("WM_APP_STORE2.AppScreenService")
@Validated
public class AppScreenServiceImpl implements AppScreenService {
    ...
    @Autowired
    @Qualifier("WM_APP_STORE2.AppScreenDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service WM_APP_STORE2 for table AppScreen to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service WM_APP_STORE2 for table AppScreen to {} format", options.getExportType());
