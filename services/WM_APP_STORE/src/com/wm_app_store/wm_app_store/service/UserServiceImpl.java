...
import com.wm_app_store.wm_app_store.User;
 ...
 * @see User
 */
@Service("WM_APP_STORE.UserService")
@Validated
public class UserServiceImpl implements UserService {
    ...
    @Autowired
    @Qualifier("WM_APP_STORE.UserDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service WM_APP_STORE for table User to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service WM_APP_STORE for table User to {} format", options.getExportType());
