 ...
 * @see MdCategory
 */
@Service("WM_APP_STORE1.MdCategoryService")
@Validated
public class MdCategoryServiceImpl implements MdCategoryService {
    ...
    @Lazy
    @Autowired
    @Qualifier("WM_APP_STORE1.AppInfoService")
    private AppInfoService appInfoService;

    @Autowired
    @Qualifier("WM_APP_STORE1.MdCategoryDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service WM_APP_STORE1 for table MdCategory to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service WM_APP_STORE1 for table MdCategory to {} format", options.getExportType());
