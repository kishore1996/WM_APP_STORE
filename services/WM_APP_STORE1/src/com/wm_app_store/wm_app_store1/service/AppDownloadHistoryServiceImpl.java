...
import com.wm_app_store.wm_app_store1.AppDownloadHistory;
 ...
 */
@Service("WM_APP_STORE1.AppDownloadHistoryService")
@Validated
public class AppDownloadHistoryServiceImpl implements AppDownloadHistoryService {
    ...
    @Autowired
    @Qualifier("WM_APP_STORE1.AppDownloadHistoryDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service WM_APP_STORE1 for table AppDownloadHistory to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service WM_APP_STORE1 for table AppDownloadHistory to {} format", options.getExportType());
