 ...
 * @see AppInfo
 */
@Service("WM_APP_STORE1.AppInfoService")
@Validated
public class AppInfoServiceImpl implements AppInfoService {
    ...
    @Lazy
    @Autowired
    @Qualifier("WM_APP_STORE1.AppSourceService")
    private AppSourceService appSourceService;

    @Lazy
    @Autowired
    @Qualifier("WM_APP_STORE1.AppScreenshotsService")
    private AppScreenshotsService appScreenshotsService;

    @Lazy
    @Autowired
    @Qualifier("WM_APP_STORE1.AppRatingService")
    private AppRatingService appRatingService;

    @Lazy
    @Autowired
    @Qualifier("WM_APP_STORE1.AppScreenService")
    private AppScreenService appScreenService;

    @Autowired
    @Qualifier("WM_APP_STORE1.AppInfoDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service WM_APP_STORE1 for table AppInfo to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service WM_APP_STORE1 for table AppInfo to {} format", options.getExportType());
