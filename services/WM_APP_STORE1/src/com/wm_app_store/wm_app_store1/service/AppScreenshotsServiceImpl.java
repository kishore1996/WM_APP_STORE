 ...
 * @see AppScreenshots
 */
@Service("WM_APP_STORE1.AppScreenshotsService")
@Validated
public class AppScreenshotsServiceImpl implements AppScreenshotsService {
    ...
    @Autowired
    @Qualifier("WM_APP_STORE1.AppScreenshotsDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service WM_APP_STORE1 for table AppScreenshots to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service WM_APP_STORE1 for table AppScreenshots to {} format", options.getExportType());
