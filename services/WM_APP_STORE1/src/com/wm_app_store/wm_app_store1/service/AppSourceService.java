...
public interface AppSourceService {
    ...
    /*
     * Returns the associated appD0wnloadHostories for given AppSource id.
     *
     * @param id value of id; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated AppD0wnloadHostory instances.
     *
     * @see Pageable
     * @see Page
     */
    Page<AppD0wnloadHostory> findAssociatedAppD0wnloadHostories(Integer id, Pageable pageable);
