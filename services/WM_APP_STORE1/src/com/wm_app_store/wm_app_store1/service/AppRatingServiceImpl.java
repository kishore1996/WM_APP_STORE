 ...
 * @see AppRating
 */
@Service("WM_APP_STORE1.AppRatingService")
@Validated
public class AppRatingServiceImpl implements AppRatingService {
    ...
    @Autowired
    @Qualifier("WM_APP_STORE1.AppRatingDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service WM_APP_STORE1 for table AppRating to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service WM_APP_STORE1 for table AppRating to {} format", options.getExportType());
