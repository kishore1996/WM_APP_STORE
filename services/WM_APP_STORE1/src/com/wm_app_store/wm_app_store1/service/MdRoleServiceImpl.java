 ...
 * @see MdRole
 */
@Service("WM_APP_STORE1.MdRoleService")
@Validated
public class MdRoleServiceImpl implements MdRoleService {
    ...
    @Autowired
    @Qualifier("WM_APP_STORE1.MdRoleDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service WM_APP_STORE1 for table MdRole to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service WM_APP_STORE1 for table MdRole to {} format", options.getExportType());
