 ...
 */
@Service("WM_APP_STORE1.AppD0wnloadHostoryService")
@Validated
public class AppD0wnloadHostoryServiceImpl implements AppD0wnloadHostoryService {
    ...
    @Autowired
    @Qualifier("WM_APP_STORE1.AppD0wnloadHostoryDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service WM_APP_STORE1 for table AppD0wnloadHostory to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service WM_APP_STORE1 for table AppD0wnloadHostory to {} format", options.getExportType());
