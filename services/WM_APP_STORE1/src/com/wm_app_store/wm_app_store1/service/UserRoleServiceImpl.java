 ...
 * @see UserRole
 */
@Service("WM_APP_STORE1.UserRoleService")
@Validated
public class UserRoleServiceImpl implements UserRoleService {
    ...
    @Autowired
    @Qualifier("WM_APP_STORE1.UserRoleDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service WM_APP_STORE1 for table UserRole to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service WM_APP_STORE1 for table UserRole to {} format", options.getExportType());
