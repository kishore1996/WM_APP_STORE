...
import com.wm_app_store.wm_app_store1.service.UserService;
 ...
 * @see User
 */
@RestController("WM_APP_STORE1.UserController")
@Api(value = "UserController", description = "Exposes APIs to work with User resource.")
@RequestMapping("/WM_APP_STORE1/User")
public class UserController {

    private static final Logger LOGGER = LoggerFactory.getLogger(UserController.class);

    @Autowired
	@Qualifier("WM_APP_STORE1.UserService")
