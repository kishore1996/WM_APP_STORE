...
import com.wm_app_store.wm_app_store1.service.AppInfoService;
 ...
 * @see AppInfo
 */
@RestController("WM_APP_STORE1.AppInfoController")
@Api(value = "AppInfoController", description = "Exposes APIs to work with AppInfo resource.")
@RequestMapping("/WM_APP_STORE1/AppInfo")
public class AppInfoController {
    ...
    public AppInfo editAppInfo(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) {
        AppInfo newAppInfo = WMMultipartUtils.toObject(multipartHttpServletRequest, AppInfo.class, "WM_APP_STORE1");
        newAppInfo.setId(id);
